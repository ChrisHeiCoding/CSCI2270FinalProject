...
*/
	...
	string encrypt(string alphabet, string cipher, string message);

	string decrypt(string alphabet, string cipher, string message);

	string makeCipher(string alphabet);
...
*/
    ...
    void BFTraversalLabel(char start_letter);
